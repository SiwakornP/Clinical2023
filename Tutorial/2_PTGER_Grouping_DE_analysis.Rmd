...
Funtion PTGER4.Group() divide cells in each cell type in each specimen/batch (ID) into PTGER4 high, PTGER4 intermediate, and PTGER4 low equally
Output: A vector contain PTGER4 group and cell barcode index

Funtion PTGER2.Group() divide cells in each cell type in each specimen/batch (ID) into PTGER2 high and PTGER2 low equally
Output: A vector contain PTGER2 group and cell barcode index
```{r}
